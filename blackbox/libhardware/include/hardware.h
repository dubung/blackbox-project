...
#define PID_GPS_DATA                0x10 //GPS 데이터(실제 존재 x)
...
#define GPS_DATA_FLAG               0x08
#define STEERING_DATA_FLAG          0x10
#define BRAKE_DATA_FLAG             0x20
#define TIRE_DATA_FLAG              0x40
#define AI_REQUEST_FLAG             0x80

#define AI_AVAILABLE                (GPS_DATA_FLAG|STEERING_DATA_FLAG)
